...
<body>
                                ...
                                <div class="p-5">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group mb-5">
                                            <label for="gaurdName">Gaurd's name</label>
                                            <input type="text" class="form-control" id="gaurdName">
                                        </div>
    ...
    <script> 
        $('#insert').click(function() {
                ...
                $.get("../api.php", {functionName:"insert", bandId:bandId, gaurdName:gaurdName }, function(data){
                    //check
